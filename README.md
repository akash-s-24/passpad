...
This app stores text and uploads on disk. For real use, deploy it to a service that supports persistent disk storage, such as Render, Railway, Fly.io, or a VPS.
